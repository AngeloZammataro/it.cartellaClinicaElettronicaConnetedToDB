...
public class Employee extends Person{
    ...
    public Employee(String name, String surname, String nationality, String placeOfBirth, LocalDate dateOfBirth, String fiscalCode, String documentNumber, String address, String city, String phoneNumber, String emailAddress, Gender gender, String login, String password, RoleInClinic roleInClinic, String badgeNumber, PlaceOfWork placeOfWork) {
