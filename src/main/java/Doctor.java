...
public class Doctor extends Employee{
    ...
    public Doctor(String name, String surname, String nationality, String placeOfBirth, Date dateOfBirth, String fiscalCode, String documentNumber, String address, String city, String phoneNumber, String emailAddress, Gender gender, String login, String password, RoleInClinic roleInClinic, String badgeNumber, PlaceOfWork placeOfWork, MedicalSpecializzation medicalSpecializzation) {
